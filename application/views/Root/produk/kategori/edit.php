...
<div class="page-body">
    <div class="container-xl">
        ...
        <form class="card" method="post" action="<?=base_url('Root/Produk/kategori_edit/'.encrypt_url($kategori->idKategori)) ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-center">
                        <div class="info-box shadow-none" style="width: 100px; height: 100px;">
                            <img src="<?= base_url('upload/kategori/'.$kategori->image)?>">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" aria-describedby="nama" placeholder="Contoh : Backpack"
                               name="nama" value="<?= $kategori->nama_kategori;?>">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="image" name="image"
                           ...
                           required>
                    <input type="hidden" name="oldimg" value="<?= $kategori->image?>">
                </div>
            </div>
