    ...
    <div class="container-xl ">
        <div class="mb-3 d-flex justify-content-end">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Category Produk</a></li>
            </ol>
        </div>
        <div class="mb-3">
            <a href="<?= base_url('Root/Produk/kategori_add')?>" class="btn btn-facebook  btn-icon" aria-label="RSS">
            ...
            <div class="card-body">
                <div id="table-default" class="table-responsive">
                    <table class="table" id="datatables">
                        <thead>
                        <tr>
                            <th><button class="table-sort" data-sort="sort-name">Nama Kategori</button></th>
