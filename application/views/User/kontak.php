                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                            ...
                            <p><span>Address:</span> Universitas Komputer Indonesia</b><br>Jl. Dipati Ukur No.112-116, Bandung.</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                            ...
                            <p><span>Phone:</span> <a href="">(022) 2504119</a></p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                            ...
                            <p><span>Email:</span> <a href="mailto:info.support@outdoorhub.com">info.support<br>@outdoorhub.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.getElementById("kontak").className += " active";
</script>
